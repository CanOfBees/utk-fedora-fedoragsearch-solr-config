...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="foxml:datastream[@ID='OCR'or @ID='ocr' or @ID='TEXT' or @ID='text' or @ID='full_text' or @ID='FULL_TEXT' or @ID='fullText' or @ID='TRANSCRIPT']/foxml:datastreamVersion[last()] |
